...
- Forwards into Discord: links are proper [text](url) links that do not unfurl, so a Salpha report is not a wall of raw URLs followed by a dozen previews. A lone bare link keeps its preview.
## v0.8.13 — 2026-09-15
