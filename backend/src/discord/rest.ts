/**
 * Discord REST with the user token — READ ONLY (channel history for previews). Sending and
 * reacting with a token were removed: those go through the Vencord bridge, never a token.
 */
