...
export const CHAINS: Record<string, ChainDef> = {
  ...
  robinhood: { network: 'robinhood', kind: 'evm', name: 'Robinhood Chain', chainId: 4663, rpc: 'https://rpc.mainnet.chain.robinhood.com', native: 'ETH', coingecko: 'ethereum', v4: '0x8366a39cc670b4001a1121b8f6a443a643e40951' },
  ...
  hyperevm: { network: 'hyperevm', kind: 'evm', name: 'HyperEVM', chainId: 999, rpc: 'https://rpc.hyperliquid.xyz/evm', alchemy: 'hyperevm-mainnet', native: 'HYPE', coingecko: 'hyperliquid' },
